...
| Points       | PointSet       | Yes             | Yes            | Float in int data supported |
| Curve        | PolyData       | Yes             | Yes            | Float in int data supported |
| Surface      | PolyData       | Yes             | Yes            | Float in int data supported |
